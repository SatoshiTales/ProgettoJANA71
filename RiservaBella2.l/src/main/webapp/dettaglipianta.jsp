...
<body>
	...
	<div class="container">
				...
				<tr>
					<td>
						<form action="/modificapianta" method="get">
							...
							FAMIGLIA <input type="text" name="famiglia"
								value="<%=p.getFamiglia()%>"><br> DESCRIZIONE <input
								type="text" name="descr" value="<%=p.getDescr()%>"><br>
		...
		<div class="updateimage" id="XY" hidden>
			<table class="update">
				<tr>
				...
				<tr>
					<td>
						<form action="" method="get">
							<input id="B" type="text" name="descr" value="" /> <input id="C"
