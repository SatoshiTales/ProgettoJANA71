    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-6" style="text-align: center;">
                <h1 id="nomeanimale">DETTAGLI PIANTA</h1>
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px;">
            <div class="col-1"></div>
            <div class="col-2">
                <a href="/elencopianteuser"><button class="bottonex">Indietro</button></a>
            </div>
            <div class="col-6" style="text-align: center;">
                <h3 class="gestionea">
                    <%=p.getNome()%>
            ...
            <div class="col-1">
				<a href="/adottapianta?idP=<%=p.getId()%>"><button class="bottoney" style="width: 100px">Adotta</button></a>
			</div>
        </div>
