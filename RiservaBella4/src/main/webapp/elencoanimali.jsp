				...
				<table class="table align-middle table-dark" id="render"
					...
					<tbody id="myTable">
						...
						<tr>
							...
							<td><a href="/dettaglianimale?id=<%= a.getId() %>"><button id='buttonModifica'>Modifica</button></a></td>
							<td><a href="/eliminaanimale?id=<%= a.getId() %>"><button id='buttonElimina'>Elimina</button></a></td>
