...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-2"></div>
			<div class="col-6">
				<h3 class="gestionea"><%=p.getNome()%></h3>
			</div>
			<div class="col-1">
		...
		<div class="row">
			<div class="col-2"></div>
			<div class="col-3">
				<img class="imggestione" src="<%=p.getImg()%>" width="400px"
					height="400px" />
			</div>
			<div class="col-1"></div>
			<div class="col-4">
