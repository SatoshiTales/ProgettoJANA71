	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-4" style="margin-top: 10px;">
				<button onclick="nohide5()">AGGIUNGI NUOVO</button>
			</div>
		</div>
		...
		<div class="row">
				...
				<table class="table align-middle table-dark" id="render"
					...
					<tbody id="myTable">
						...
						<tr>
							...
							<td><a href="/dettaglianimale?id=<%= a.getId() %>"><button
										id='buttonModifica'>Modifica</button></a></td>
							<td><a href="/eliminaanimale?id=<%= a.getId() %>"><button
			...
			<div style="border-radius: 5px;" class="create" id="ZX" hidden = "true">
				...
				<div style="margin-top: 0.5cm" id="tabella animali" align="center">
					<h5 style="margin-bottom: 30px;">INSERISCI ANIMALE</h5>
					<div></div>
					<form action="/nuovoanimale" method="get" style="margin-right: 10px;">
					<table class="createanimal">
						<thead>
							...
							<tr>
								<td>INSERISCI SESSO</td>
								<td><input style="border: 2px solid #216b39;" type="text"
									id="sex-a" name="sesso" value="" /></td>
							</tr>
							<tr>
								<td>INSERISCI CLASSE</td>
								<td><input style="border: 2px solid #216b39;" type="text"
									id="class-a" name="classe" value="" /></td>
							</tr>
								<tr>
								<td><input style="border: 2px solid #216b39;" type="text"
