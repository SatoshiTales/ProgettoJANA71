    ...
    public String handleImageUploadA(@RequestParam("image") MultipartFile image, @RequestParam("id") int id) {
        try {
            if (!image.isEmpty()) {
                ...
                File uploadedImage = new File("C:\\Users\\Weeb Lord\\Documents\\Robe random\\El corso\\Progetti\\RiservaBella00\\RiservaBella5.1\\src\\main\\webapp\\img", image.getOriginalFilename());
