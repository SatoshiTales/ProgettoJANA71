...
public class UserController {
	...
	public String logout(HttpSession session) {
		...
		session.removeAttribute("animali");
		session.removeAttribute("piante");
	...
	public String adozioni(HttpSession session, Model model) {
		...
		session.setAttribute("animali", aDao.leggiAdozioni(usr.getId()+ ""));
		session.setAttribute("piante", pDao.leggiAdozioni(usr.getId()+ ""));
		
		return "redirect:/adozioni.jsp";
	}
