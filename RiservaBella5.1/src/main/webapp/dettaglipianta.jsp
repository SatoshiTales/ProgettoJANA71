...
<head>
    ...
    <title>Gestione Amm. Piante</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-6" style="text-align: center;">
                <h1 id="nomeanimale">GESTIONE PIANTA</h1>
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px;">
            <div class="col-1"></div>
            <div class="col-2">
                <a href="/elencopiante"><button class="bottonex">Indietro</button></a>
            </div>
            <div class="col-6" style="text-align: center;">
                <h3 class="gestionea">
                    <%=p.getNome()%>
        ...
        <div class="row" style="margin-top: 20px;">
            <div class="col-4"></div>
            <div class="col-4">
                <img class="imggestione" src="<%=p.getImg()%>" width="420px" height="355px" />
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <form action="/modificapianta" method="get">
                        ...
                        <input type="text" name="famiglia" value="<%=p.getFamiglia()%>" readonly hidden="true"><br>
                        <input type="text" name="descr" value="<%=p.getDescr()%>" readonly hidden="true"><br>
        ...
        <div class="updateimage" id="XY" hidden="true">
            ...
            <form method="post" action="uploadImageP" enctype="multipart/form-data">
                <input type="text" name="id" value="<%=p.getId()%>" readonly hidden="true"><br>
                <input id="inputFile" type="file" name="image" value="<%=p.getImg()%>" style="margin-left: 10px;" />
        ...
        <div class="updatedescr" id="YY" hidden style="height: 470px; width: 470px; padding: 20px;">
            ...
            <form action="/modificapianta" method="get">
                ...
                <input type="text" name="id" value="<%=p.getId()%>" readonly hidden="true"><br>
                <input type="text" name="nome" value="<%=p.getNome()%>" readonly hidden="true"><br>
                <input type="text" name="famiglia" value="<%=p.getFamiglia()%>" readonly hidden="true"><br>
                  <textarea name="descr" id="" cols="50" rows="8"  value="<%=p.getDescr()%>" ></textarea>
                <input type="submit" value="AGGIORNA">
            </form>
